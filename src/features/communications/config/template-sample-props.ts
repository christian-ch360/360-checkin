...
export const TEMPLATE_SAMPLE_PROPS: { [K in TemplateName]: TemplateProps[K] } = {
  ...
  campaign_request_admin: {
    ...
    brandWebsite: "https://glowskincare.com",
    contactName: "Sam Rivera",
    contactEmail: "sam@glowskincare.com",
    contactPhone: "(555) 123-4567",
    campaignType: "Product Launch",
    objective: "Introduce our new vitamin C serum to a beauty-focused audience ahead of the holiday season.",
    budget: "$50,000 total · $2,500 per creator preferred · Some Flexibility",
    categories: "Beauty, Lifestyle",
    platforms: "INSTAGRAM, TIKTOK",
    desiredReach: "Micro, Mid-Tier",
    location: "United States",
    deliverables: "Feed Post, Reel",
    creatorCount: "10",
    timeline: "Launching in 6 weeks",
    reviewUrl: "https://creatorhub360.com/admin/creator-library/campaign-requests",
  },
  daily_admin_summary: {
    fullName: "Jordan Admin",
    date: now(),
